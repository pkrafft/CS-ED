...
1.  First, you should consult the introduction to file directories and Github [here](./terminal_and_git.html). This is crucial to properly logging and saving the work you produce.

2.  Second, you should consult the worksheet [here](./intror.html), which is an introduction to setting up and understanding the very basics of working in R.
